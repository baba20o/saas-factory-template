    ...
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {stats.map((stat) => (
          <div
            key={stat.key}
            className="rounded-2xl border border-glass-border bg-glass-surface backdrop-blur-xl p-6"
          >
            ...
            <p className="text-xs text-text-muted mt-1">No data yet</p>
          </div>
        ))}
      </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <button
            className="rounded-2xl border border-glass-border bg-glass-surface p-6 text-left transition-all duration-200 hover:bg-white/[0.06] hover:border-white/20 group"
          >
            <div
            ...
            <h3 className="text-sm font-semibold text-text-primary">Create new plan</h3>
            <p className="text-xs text-text-muted mt-1">Start a new project plan from scratch</p>
          </button>
          ...
          <a
            ...
            className="rounded-2xl border border-glass-border bg-glass-surface p-6 text-left transition-all duration-200 hover:bg-white/[0.06] hover:border-white/20 group"
          >
            <div className="w-10 h-10 rounded-xl flex items-center justify-center mb-3 bg-white/10 text-text-secondary transition-transform group-hover:scale-110">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
              </svg>
            </div>
            <h3 className="text-sm font-semibold text-text-primary">View docs</h3>
            <p className="text-xs text-text-muted mt-1">Learn how to get the most out of {config.product.name}</p>
          </a>
          ...
          >
            ...
            <p className="text-xs text-text-muted mt-1">Manage your profile and preferences</p>
          </a>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="rounded-2xl border-dashed border-border bg-glass-surface p-12 text-center">
          ...
          <p className="text-xs text-text-muted mt-1">Get started by creating your first plan.</p>
        </div>
      </div>
    </div>
  );
